            ...
            <div>
              ...
              <div className="bg-white px-5 mt-6">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    className="totalpricebtn w-full sm:w-auto px-4 py-2 bg-purple-600 text-white rounded-lg text-lg cursor-pointer transition-all duration-300 hover:bg-purple-700"
